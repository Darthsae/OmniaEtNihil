...
public class CrudeJawCrusherScreen extends AbstractContainerScreen<CrudeJawCrusherMenu> {
    private static final ResourceLocation CRUDE_JAW_CRUSHER_TEXTURE = ResourceLocation.fromNamespaceAndPath(OmniaEtNihil.MODID, "textures/gui/menu/crude_jaw_crusher.png");
    ...
    public CrudeJawCrusherScreen(CrudeJawCrusherMenu menu, Inventory inventory, Component title) {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        int i = this.leftPos;
        int j = this.topPos;
        guiGraphics.blit(CRUDE_JAW_CRUSHER_TEXTURE, i, j, 0, 0, this.imageWidth, this.imageHeight);
        ...
        guiGraphics.blit(CRUDE_JAW_CRUSHER_TEXTURE, i + 136, j + 56 + offsetYProgress, 176, offsetYProgress, 6, sizeYProgress);
        guiGraphics.blit(CRUDE_JAW_CRUSHER_TEXTURE, i + 136, j + 34 + offsetYEnergy, 176, offsetYEnergy, 6, sizeYEnergy);
        /*
