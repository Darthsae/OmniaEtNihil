...
public class CorruptStorageModel extends GeoModel<CorruptStorageBlockEntity> {
    ...
    private static final ResourceLocation texture = ResourceLocation.fromNamespaceAndPath(OmniaEtNihil.MODID,
            "textures/block/corrupt_storage.png");
    ...
    private static final ResourceLocation animation = ResourceLocation.fromNamespaceAndPath(OmniaEtNihil.MODID,
            "animations/corrupt_storage.animation.json");

    @Override
    public ResourceLocation getModelResource(CorruptStorageBlockEntity object) {
        return CorruptStorageModel.model;
    }

    @Override
    public ResourceLocation getTextureResource(CorruptStorageBlockEntity object) {
        return CorruptStorageModel.texture;
    }

    @Override
    public ResourceLocation getAnimationResource(CorruptStorageBlockEntity object) {
        return CorruptStorageModel.animation;
    }
